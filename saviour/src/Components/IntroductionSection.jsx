    ...
    return (
        <div className='border-4'>
            <div>
                ...
                <p  className='w-587 h-207 leading-24 text-24 font-normal font-zcool absolute top-753 left-166'>We've all been in the mud once, and now we've decided to fight it out.
